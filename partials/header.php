			...
			<div class="wrapper">
				...
				<div class="right">
					<div class="wrap-search">
						...
						<div class="wrap-user">
							<button class="img-md-round userBtn"><span><img src="<?= ROOT_URL ?>thumbnails/<?= $user['profile'] ?>"></span></button>
							<div style="box-shadow:0px 0px 5px rgba(0,0,0,.5);" class="dropdown-container">
								<div class="top">
									<div class="left">
										<div class="img-sm-round" style="border: 2px solid hsl(209, 92%, 55%);;"><img src="<?= ROOT_URL ?>thumbnails/<?= $user['profile'] ?>"></div>
										<div class="info">
											<h4 class="name"><?= $user['firstname'] . ' ' . $user['lastname']  ?></h4>
											<a href="<?= ROOT_URL ?>settings.php">See your profile</a>
										</div>
									</div>
